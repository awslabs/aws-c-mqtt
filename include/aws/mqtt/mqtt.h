...
enum aws_mqtt_error {
    AWS_ERROR_MQTT_INVALID_RESERVED_BITS = AWS_C_MQTT_PACKAGE_ID * AWS_ERROR_ENUM_STRIDE,
    ...
    AWS_ERROR_END_MQTT_RANGE = (AWS_C_MQTT_PACKAGE_ID + 1) * AWS_ERROR_ENUM_STRIDE - 1,
};

enum aws_mqtt_log_subject {
    AWS_LS_MQTT_GENERAL = AWS_C_MQTT_PACKAGE_ID * AWS_LOG_SUBJECT_STRIDE,
    AWS_LS_MQTT_CLIENT,
