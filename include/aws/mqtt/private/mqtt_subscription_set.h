...
struct aws_mqtt_subscription_set {
    ...
    struct aws_mqtt_subscription_set_topic_tree_node *root; // implicitly have a permanent ref
};
 ...
 * @return
 */
AWS_MQTT_API bool aws_mqtt_subscription_set_is_topic_filter_subscribed(
