...
/* suback reason codes */
#define AWS_MQTT5_SUBACK_REASON_CODE_GRANTED_QOS_0 ((uint8_t)0)
#define AWS_MQTT5_SUBACK_REASON_CODE_GRANTED_QOS_1 ((uint8_t)1)
#define AWS_MQTT5_SUBACK_REASON_CODE_GRANTED_QOS_2 ((uint8_t)2)
#define AWS_MQTT5_SUBACK_REASON_CODE_UNSPECIFIED_ERROR ((uint8_t)128)
#define AWS_MQTT5_SUBACK_REASON_CODE_IMPLEMENTATION_SPECIFIC_ERROR ((uint8_t)131)
#define AWS_MQTT5_SUBACK_REASON_CODE_NOT_AUTHORIZED ((uint8_t)135)
#define AWS_MQTT5_SUBACK_REASON_CODE_TOPIC_FILTER_INVALID ((uint8_t)143)
#define AWS_MQTT5_SUBACK_REASON_CODE_PACKET_IDENTIFIER_IN_USE ((uint8_t)145)
#define AWS_MQTT5_SUBACK_REASON_CODE_QUOTA_EXCEEDED ((uint8_t)151)
#define AWS_MQTT5_SUBACK_REASON_CODE_SHARED_SUBSCRIPTIONS_NOT_SUPPORTED ((uint8_t)158)
#define AWS_MQTT5_SUBACK_REASON_CODE_SUBSCRIPTION_IDENTIFIERS_NOT_SUPPORTED ((uint8_t)161)
#define AWS_MQTT5_SUBACK_REASON_CODE_WILDCARD_SUBSCRIPTIONS_NOT_SUPPORTED ((uint8_t)162)
