...
/*
 * TODO: See above note about not making this assume 1-1 with MQTT packets.  This is essentiall a placeholder
 * until we hash out more details about how operations are processed, encode, decode, etc...
 */
